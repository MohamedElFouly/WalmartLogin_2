...
class ElectronicsCategoryActivity : AppCompatActivity(), CategoryAdapter.Callback {
    ...
    private val productList = mutableListOf(
        ...
        Product("Echo Show","$127", "Black", R.drawable.echo_show, 1236L, "Echo Show features a new look, a vibrant 10.1” HD screen, built-in smart home hub, and improved speakers that deliver expansive stereo sound. Just ask Alexa to show you a recipe, watch live TV and sports with Hulu, make video calls, or see who’s at the front door.")
    )
